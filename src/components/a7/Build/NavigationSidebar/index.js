...
const NavigationSidebar = (
    ...
    return(
        <div classNameName = "list-group">
            <Link to="/a7/practice" className="list-group-item wd-left-logos">
                <i className="fab fa-twitter"></i>
            </Link>
            <Link to ="/a7/twitter/home" className={`list-group-item wd-left-logos ${active === 'home' ? 'active' : '' }`} >
                <i className="fas fa-home"></i><span className = "ps-2 d-none d-xl-inline d-xxl-inline">Home</span>
            </Link>
            <Link to = "/a7/twitter/explore" className={`list-group-item wd-left-logos ${active === 'explore' ? 'active' : '' }`} >
            ...
            <Link to="/a7/twitter/profile" className={`list-group-item wd-left-logos ${active === 'profile' ? 'active' : '' }`} >
